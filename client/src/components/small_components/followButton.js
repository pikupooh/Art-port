...
class FollowButton extends React.Component{
    ...
    followUser = () => {
        addFollower(this.props.userId, this.props.logInId)
    }
    ...
    render(){
        ...
        if(this.props.userId === "" || this.props.userId === this.props.logInId){
            return(
                <div>
            ...
            return(
                <Button className="follow_button" onClick = {this.followUser}>Follow</Button>
            )
        }
        return(
            <Button className="follow_button" onClick = {this.unfollowUser}>Unfollow</Button>
        )
    }
}
