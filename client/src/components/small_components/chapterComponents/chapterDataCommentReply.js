...
class ChapterDataCommentsReply extends Component{
    ...
    deleteReply = () => {
       this.props.deleteChapterReply(this.props.reply.id, this.props.reply.comment);
    }
        ...
        return(
            <div className = "ml-5">
                <div className = "ml-5">
                    ...
                    <ChapterCommentEditReplyForm isEdit = {this.state.isEdit}
                                            closeEditReplyForm = {this.closeEditReplyForm}
...
export default connect(mapStateToProps, mapDispatchToProps)(ChapterDataCommentsReply)
