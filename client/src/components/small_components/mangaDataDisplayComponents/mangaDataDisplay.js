...
function MangaDataDisplay(props) {
    ...
    if (props.userRatings)
        rate =
            props.userRatings[props.mangaId] === undefined
                ? 0
                : props.userRatings[props.mangaId];
    else {
        rate = 0;
    }
    ...
    return (
        <div className="manga_data_container">
            <Row className="my-4">
                    ...
                    {props.photo && (
                        <div className="manga_data_manga_image_container">
                            <Image
                                ...
                                className="manga_data_manga_image"
                                alt="manga_cover_photo"
                            ></Image>
                        </div>
                    )}
                </Col>
                <Col>
                    <Container>
                        <Row className="manga_data_title ">{props.title}</Row>
                        ...
                        <Row className="manga_data_rating">
                            ...
                            <div className="ml-auto mr-3">
                                {props.author.id === props.userId && (
                                    <Button
                                        id="add_chapter_button"
                                        onClick={props.handleFormModalShow}
                                    >
                                        + Add Chapter
                                    </Button>
                                )}
