...
import postMangaComment from "../../../../redux/thunk/post/postMangaComment"

class MangaCommentSection extends React.Component{
...
export default connect(mapStateToProps, mapDispatchToProps)(MangaCommentSection)